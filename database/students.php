...
<html>
	...
	<body>	
		...
		<?php
			...
			if($_SESSION['but'] == "admin"){
				...
				if(mysqli_num_rows($result) > 0){
					...
					<tr><th>Student Number</th><th>Name</th><th>Sex</th><th>College</th>
					<th>Program</th><th>Permanent Address</th><th>Present Address</th>
					<th>Contact Number</th><th>E-mail</th><th>year_lvl</th></tr>";
			...
			if($_SESSION['but'] == "inst"){
				...
				echo "<h2>Students you Advise</h2><br>";

				$query = "select distinct student.* from student natural join advises where advises.instructor_number = '".$_SESSION['idnum']."'";
				$result = mysqli_query($conn,$query);
				if(mysqli_num_rows($result) > 0){
					echo "<table class='cTable'>
					<tr><th>Student Number</th><th>Name</th><th>Sex</th><th>College</th>
			...
			if($_SESSION['but'] == "stud"){
				...
				echo "<h2>Personal Information</h2><br>";
					...
					<div id='mainDiv'>
						...
						<table class='cTable'>
							...
							<tr>
								...
								<td id =\"snum\">".$row['student_number']."</td>
							</tr>
							<tr>
								<td>College</td>
								<td>".$row['college']."</td>
		...
		<button><a href='index.php'>Return to Main Page</a></button><hr>
